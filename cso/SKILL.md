...
**Config files with prod credentials:** Use Grep to search for database connection strings (LOCAL_DATABASE_URL_REMOVED LOCAL_DATABASE_URL_REMOVED LOCAL_DATABASE_URL_REMOVED LOCAL_DATABASE_URL_REMOVED in config files, excluding localhost/127.0.0.1/example.com. Check for staging/dev configs referencing prod.
