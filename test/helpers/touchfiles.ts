...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'aOPENAI_API_KEY_REMOVED':              ['plan-ceo-review/**', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble/generate-completeness-section.ts', 'scripts/resolvers/preamble.ts', 'test/helpers/claude-pty-runner.ts'],
...
export const E2E_TIERS: Record<string, 'gate' | 'periodic'> = {
  ...
  'aOPENAI_API_KEY_REMOVED':            'gate',       // ~$0.50/run, single skill probe
